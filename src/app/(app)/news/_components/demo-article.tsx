      ...
      <section className="flex flex-col gap-16">
        <article className="col-span-2 mx-auto max-w-screen-lg flex flex-col gap-8 article">
          ...
          <p>
            ...
            you might need when writing a blog post. Whether you’re talking
            about <em>code snippets</em>, quoting someone famous, or creating
            bullet lists, we’ve got you covered!
          </p>

          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Autem sed
            cupiditate est minus fugiat praesentium dolores quam pariatur
            tenetur! Illo eos, temporibus facilis officiis necessitatibus
          ...
          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Autem sed
            cupiditate est minus fugiat praesentium dolores quam pariatur
            tenetur! Illo eos, <a href="/">temporibus</a> facilis officiis
            necessitatibus voluptatem suscipit deleniti velit. Facilis. Lorem
            ipsum dolor, sit amet consectetur adipisicing elit. Blanditiis alias
            qui quaerat repellat! Incidunt provident culpa maiores tenetur
            consequuntur, accusantium nemo laudantium, harum quis perferendis a
            temporibus cumque voluptatibus quas!
          </p>
          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Autem sed
            cupiditate est minus fugiat praesentium dolores quam pariatur
          ...
          <p>
            ...
            Quisque viverra velit ut velit fermentum, in tincidunt libero
            luctus.
          </p>
